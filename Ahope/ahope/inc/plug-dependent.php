...
function ahope_single_title($arg){

        if ( is_category() ) {
            /* translators: Category archive title. 1: Category name */
            $title = single_cat_title( $arg['cat'], 'ahope');
        } elseif ( is_tag() ) {
            /* translators: Tag archive title. 1: Tag name */
            $title = single_cat_title( $arg['tag'], 'ahope');
        } elseif ( is_author() ) {
...
function ahope_unit_breadcumb($separator = ' / ') {
    /* === OPTIONS === */
