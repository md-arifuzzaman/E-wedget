...
add_action( 'elementor/element/after_section_end', function( $element, $section_id, $args ) {
    ...
    if ( 'section' === $element->get_name() && 'section_custom_css_pro' === $section_id ) {
        ...
        $element->add_control(
            'header_sticky',
            [
                'label'        =>   __( 'Sticky Section', 'ahope' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     =>   __( 'Yes', 'ahope' ),
                'label_off'    =>   __( 'No', 'ahope' ),
                'return_value' => 'ahope-sticky-header',
                'default'      => '',
                'prefix_class' => '',
            ]
        );
        $element->add_group_control(
            ...
            [
                'name' => 'sticky_bg',
                'label' => __( 'Main BG', 'ahope' ),
                'types' => [ 'classic', 'gradient' ],
                'show_label' => true,
                'condition' => [
                    'header_sticky' => 'ahope-sticky-header'
                ],
                'selector' => '{{WRAPPER}}.ahope-sticky-header.sticky-on',
            ]
        );
        ...
        $element->add_responsive_control(
            '_element_width',
            [
                'label' => __( 'Width', 'ahope' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => '',
                'options' => [
                    '' => __( 'Default', 'ahope' ),
                    'inherit' => __( 'Full Width', 'ahope' ) . ' (100%)',
                    'auto' => __( 'Inline', 'ahope' ) . ' (auto)',
                    'initial' => __( 'Custom', 'ahope' ),
                ],
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => __( 'Vertical Align', 'ahope' ),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
                    'flex-start' => [
                        'title' => __( 'Start', 'ahope' ),
                        'icon' => 'eicon-v-align-top',
                    ],
                    'center' => [
                        'title' => __( 'Center', 'ahope' ),
        ...
        $element->add_control(
            ...
            [
                'raw' => '<strong>' . __( 'Please note!', 'ahope' ) . '</strong> ' . __( 'Custom positioning is not considered best practice for responsive web design and should not be used too frequently.', 'ahope' ),
        ...
        $element->add_control(
            '_position',
            [
                'label' => __( 'Position', 'ahope' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => '',
                'options' => [
                    '' => __( 'Default', 'ahope' ),
                    'absolute' => __( 'Absolute', 'ahope' ),
                    'fixed' => __( 'Fixed', 'ahope' ),
                ],
        ...
        $start = is_rtl() ? __( 'Right', 'ahope' ) : __( 'Left', 'ahope' );
        $end = ! is_rtl() ? __( 'Right', 'ahope' ) : __( 'Left', 'ahope' );

        $element->add_control(
            '_offset_orientation_h',
            [
                'label' => __( 'Horizontal Orientation', 'ahope' ),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'toggle' => false,
                'default' => 'start',
                'options' => [
        ...
        $element->add_control(
            ...
            [
                'label' => __( 'Vertical Orientation', 'ahope' ),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'toggle' => false,
                'default' => 'start',
                'options' => [
...
add_action( 'elementor/element/heading/section_title_style/before_section_start', function( $element, $args ) {
    ...
    $element->add_control(
        'text_transparent',
        [
            'label'        =>   __( 'Transparent', 'ahope' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'ahope' ),
            'label_off'    =>   __( 'No', 'ahope' ),
            'return_value' => 'ahope-text-gradient',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    $element->add_group_control(
        ...
        [
            ...
            'separator' => 'after',
            'condition' => [
                'text_transparent' => 'ahope-text-gradient'
            ],
            'selector' => '{{WRAPPER}}.ahope-text-gradient .elementor-heading-title',
        ]
    );
    $element->add_control(
        'text_sr',
        [
            'label' => __( 'Text Stroke', 'ahope' ),
            'type' => \Elementor\Controls_Manager::HEADING,
        ]
    );
    $element->add_control(
        'text_str',
        [
            'label'        =>   __( 'Turn On Stroke', 'ahope' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'ahope' ),
            'label_off'    =>   __( 'No', 'ahope' ),
            'return_value' => 'ahope-text-stroke',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    $element->add_control(
        's_fill_color',
        [
            'label' => __( 'Fill Color', 'ahope' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'condition' => [
                'text_str' => 'ahope-text-stroke'
            ],
            'selectors' => [
                '{{WRAPPER}}.ahope-text-stroke .elementor-heading-title' => '-webkit-text-fill-color: {{VALUE}}',
            ],
        ]
    );
    $element->add_responsive_control(
        ...
        [
            ...
            'selectors' => [
                '{{WRAPPER}}.ahope-text-stroke .elementor-heading-title' => '-webkit-text-stroke-width: {{SIZE}}{{UNIT}};',
            ],
            'condition' => [
                'text_str' => 'ahope-text-stroke'
            ],
    ...
    $element->add_control(
        's_text_color',
        [
            'label' => __( 'Stroke Color', 'ahope' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'condition' => [
                'text_str' => 'ahope-text-stroke'
            ],
            'selectors' => [
                '{{WRAPPER}}.ahope-text-stroke .elementor-heading-title' => '-webkit-text-stroke-color: {{VALUE}}',
            ],
        ]
    );
    $element->end_controls_section();
...
add_action( 'elementor/element/button/section_style/before_section_start', function( $element, $args ) {
    ...
    $element->start_controls_section(
        ...
        [
            'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            'label' => __( 'Ahope Settings', 'appilo' ),
        ]
    );
...
add_action( 'elementor/element/icon/section_style_icon/before_section_start', function( $element, $args ) {
    ...
    $element->add_control(
        'icon_light_box',
        [
            'label'        =>   __( 'Turn On LightBox', 'ahope' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'ahope' ),
            'label_off'    =>   __( 'No', 'ahope' ),
            'return_value' => 'ahope-icon-lightbox',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    $element->add_control(
        'icon_gradient',
        [
            'label'        =>   __( 'Turn On Gradient', 'ahope' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'ahope' ),
            'label_off'    =>   __( 'No', 'ahope' ),
            'return_value' => 'ahope-icon-gradient',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    ...
    $element->start_controls_tab(
        ...
        [
            'label' => __( 'Normal', 'appilo' ),
            'condition' => [
                'icon_gradient' => 'ahope-icon-gradient'
            ],
        ]
    );
    $element->add_control(
    ...
    $element->add_group_control(
        ...
        [
            ...
            'show_label' => true,
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.ahope-icon-gradient .elementor-icon i',
        ]
    );
    $element->add_control(
        'atext_gra',
    ...
    $element->add_group_control(
        ...
        [
            ...
            'show_label' => true,
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.ahope-icon-gradient .elementor-icon',
        ]
    );
    $element->end_controls_tab();
    ...
    $element->add_group_control(
        ...
        [
            ...
            'show_label' => true,
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.ahope-icon-gradient .elementor-icon:hover i',
        ]
    );
    $element->add_control(
        'afatext_gra',
    ...
    $element->add_group_control(
        ...
        [
            ...
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.ahope-icon-gradient .elementor-icon:hover',
        ]
    );
    $element->end_controls_tab();
...
function ahope_check_odd_even($data){
    if($data % 2 == 0){
        $data = "Even";
    }
    else{
...
function ahope_list_control($settings, $icon, $tag="li"){
    if(!empty($settings)){
...
function ahope_image_size_choose() {
...
function ahopeelement_template_select() {
...
/*Meta Fields*/
function ahopeelement_animations(){
    return array(
        '' => esc_html__('No animation', 'ahopeelement') ,
        'reveal-top' => esc_html__('Animate from top', 'ahopeelement') ,
        'reveal-bottom' => esc_html__('Animate from bottom', 'ahopeelement') ,
        'reveal-left' => esc_html__('Animate from left', 'ahopeelement') ,
        'reveal-right' => esc_html__('Animate from right', 'ahopeelement') ,
    );  
}
...
function ahope_get_column_class($column_size = 3, $no_margin = false) {
...
function ahopeelement_gird_column($column_size = '3') {
...
function ahopeelement_gallery_column($column_size = 3) {
...
function ahope_bg_images($thumbnail='full'){
...
function ahope_page_title($arg){
        ...
        if ( is_category() ) {
          ...
          $title = esc_html__( 'Frontpage', 'ahope' );
        } elseif( is_singular() ){
          $title = get_the_title();
        }else {
            $title = esc_html__( 'Archives','ahope' );
        }
