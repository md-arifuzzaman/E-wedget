...
class ahope_nav_builder extends Widget_Base {
    ...
    public function get_title() {
        return __('Nav Menu Builder', 'ahope');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'flex-end' => [
                        'title' => __( 'Right', 'ahope' ),
                        'icon' => 'eicon-text-align-right',
                    ],
                ],
                'selectors' => [
                    '{{WRAPPER}} .ahope-main-header.ahope-nav-builder' => 'justify-content: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'droph',
            [
                'label' => __( 'DropDown Hover BG', 'ahope' ),
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'm_fonts',
                'label' => __( 'Main Typography', 'ahope' ),
...
<!-- Start of header section
	============================================= -->
<header class="ahope-main-header ahope-nav-builder">
...
Plugin::instance()->widgets_manager->register_widget_type( new ahope_nav_builder() );